...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var bgYellow:FlxSprite = new FlxSprite(0, 56).makeGraphic(FlxG.width, 386, FlxColor.BLACK);
		var bgWhite = new FlxSprite(0, 386 + 56).makeGraphic(FlxG.width, 8, FlxColor.WHITE);
		...
		for (char in 0...3)
		{
			var cname = charArray[char];

			var weekCharacterThing:MenuCharacter = new MenuCharacter((FlxG.width * 0.25) * (1 + char) - 150, cname);
